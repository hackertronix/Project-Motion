...
public class DetailsFragment extends Fragment {
  ...
  private RelativeLayout mTrailersContainer;
  ...
  @TargetApi(Build.VERSION_CODES.LOLLIPOP) @Nullable @Override
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    if (Build.VERSION.SDK_INT != 21) {
      fontBold =
          Typeface.createFromAsset(getActivity().getAssets(), "fonts/Gotham-Rounded-Bold.ttf");
      fontMedium =
          Typeface.createFromAsset(getActivity().getAssets(), "fonts/Gotham-Rounded-Medium.ttf");
      fontMediumLight =
          Typeface.createFromAsset(getActivity().getAssets(), "fonts/Gotham-Rounded-Book_.ttf");
  ...
  private void fetchReviews() {
    ...
    call.enqueue(new Callback<TMBDReviews>() {
      @Override public void onResponse(Call<TMBDReviews> call, Response<TMBDReviews> response) {
      ...
      @Override public void onFailure(Call<TMBDReviews> call, Throwable t) {
  ...
  private void fetchTrailers() {
    ...
    call.enqueue(new Callback<TMDBTrailers>() {
      @Override public void onResponse(Call<TMDBTrailers> call, Response<TMDBTrailers> response) {
        if (response != null && response.body() != null) {
          ...
          mTrailersContainer.setVisibility(GONE);
        }
      }

      @Override public void onFailure(Call<TMDBTrailers> call, Throwable t) {
    ...
    mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        if (movie != null) {
          ...
          mFloatingActionButton.setImageResource(R.drawable.ic_favorite_border_black_24dp);
          Snackbar snackbar = Snackbar.make(mCoordinatorLayout, "Movie removed from Favourites!!",
          ...
          RxEventBus.getInstance().setMessage("DB Changed");
          mFloatingActionButton.setImageResource(R.drawable.ic_favorite_black_24dp);
          Snackbar snackbar = Snackbar.make(mCoordinatorLayout, "Movie added to Favourites!!",
              Snackbar.LENGTH_SHORT);
          View view = snackbar.getView();
          TextView textView = view.findViewById(android.support.design.R.id.snackbar_text);
          textView.setTextColor(Color.YELLOW);
