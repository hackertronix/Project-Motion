...
public class TopRatedMoviesFragment extends Fragment {
  ...
  private void fetchData(final int page) {
    ...
    Call<TMDBResponse> call =
        moviesAPI.fetchTopRatedMovies(AppConstants.API_KEY, AppConstants.SORT_R_RATED, page);

    call.enqueue(new Callback<TMDBResponse>() {
      @Override public void onResponse(Call<TMDBResponse> call, Response<TMDBResponse> response) {
        if (page > 1) {
      ...
      @Override public void onFailure(Call<TMDBResponse> call, Throwable t) {
